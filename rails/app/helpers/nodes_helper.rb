module NodesHelper
  ...
  def report_count_graph(time = Time.zone.now)
    ...
    flot_graph(data_points, 'report_count_graph', 'index')
  end
  ...
  def node_total_failure_graph(node, time = Time.zone.now)
    ...
    flot_graph(data_points, "node_#{node.id}_failure_graph", 'index')
  end
  ...
  def total_resource_graph(time = Time.zone.now)
    ...
    flot_graph(data_points, 'total_resource_graph', 'index')
  end
  ...
  def node_total_resource_graph(node, time = Time.zone.now)
    ...
    flot_graph(data_points, "node_#{node.id}_resource_graph", 'index')
  end
